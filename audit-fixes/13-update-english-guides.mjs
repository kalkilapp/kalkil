...
for (const slug of slugs) {
  ...
  // switcher estático — idempotente: sacar CSS/switcher viejo antes de insertar el
  // actualizado, así correr este script de nuevo (ej. tras un fix de color) reemplaza
  // en vez de duplicar o dejar el bloque viejo sin tocar
